...
# ./bubblesrrt -logtostderr=false --output_type=times ../motion-planning-data/generated/generated_solid___abb-irb-120___hard___KD_TREE___RBT___false___1*200.task >> ../tests/abb/rbt_abb_hard_$BUR_SIZE
# # GETTING PATH
